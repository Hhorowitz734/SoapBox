...
function Navbar({option1, option2, option3, option4, onclick1, onclick2, onclick3}){
    ...
    return(
        <div>
            <div className = 'h-16 border mt-1 p-4 flex items-center'>
                ...
                <div className="ml-auto hidden md:flex justify-between w-3/6">
                    ...
                    <h1 className="text-2xl cursor-pointer hover:text-gray-500 transition duration-300 mr-8lg:mr-16" onClick={onclick3}>{option3}</h1>
                </div>
            ...
            {menuOpen && (
                <div className="fixed w-full bg-gray-200 opacity-90 text-center h-1/4 md:hidden">
